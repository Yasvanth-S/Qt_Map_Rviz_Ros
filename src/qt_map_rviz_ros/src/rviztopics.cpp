#include "../include/qt_map_rviz_ros/rviztopics.hpp"
#include "ui_rviztopics.h"

RvizTopics::RvizTopics(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::RvizTopics)
{
    ui->setupUi(this);
    initUi();
    connect(ui->treeWidget,SIGNAL(currentItemChanged(QTreeWidgetItem *, QTreeWidgetItem *)),this,SLOT(slotCurritemChanged(QTreeWidgetItem *, QTreeWidgetItem *)));
...
void RvizTopics::slotCurritemChanged(QTreeWidgetItem *current, QTreeWidgetItem *previous)
{
...
void RvizTopics::onPushButtonOkClicked()
{
...
void RvizTopics::onPushButtonCancelClicked()
{
    this->close();
}
